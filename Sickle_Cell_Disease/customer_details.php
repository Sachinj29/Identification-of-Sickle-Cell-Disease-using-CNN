...
if (isset($_GET['name'])) {
    ...
    $query = "SELECT Name, Date, Birth_date, Age, Contact_No,Status, Image FROM patient WHERE Name = '$customer_name'";
    ...
    <div class="customer-details">
        <div class="container">
            <div class="details">
                ...
                <?php 
    if (!empty($customer_data['Image'])) {
        echo "<img src='" . $customer_data['Image'] . "'>";
    } else {
