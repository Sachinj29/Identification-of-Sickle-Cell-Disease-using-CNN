    ...
    <section id="banner" class="banner">
        <div class="bg-color">
            ...
            <div class="container image-upload-container">
                <!--<form action="upload.ppatientNamehp" method="post" enctype="multipart/form-data">
                ...
                <form action="upload.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <input type="text" name="patientName" id="" class="form-control" required>
                    ...
                    <input type="date" name="appointmentDate" id="appointmentDate" class="form-control" min=birthdate required>

                    <label for="contactNumber">Contact Number:</label>
                    <input type="tel" name="contactNumber" id="contactNumber" class="form-control" pattern="[0-9]{10}" required>
    ...
    <script>
        function validateForm() {
            ...
            if (age != calculatedAge) {
                alert("Age does not match birthdate.");
                return false;
            }

            if (appointmentDate <= birthdate) {
                alert("Appointment date must be after birthdate.");
                return false;
            }
