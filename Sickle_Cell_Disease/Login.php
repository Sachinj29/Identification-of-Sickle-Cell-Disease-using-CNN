        ...
        <div class="login">
            <div class="login__content">
                ...
                <div class="login__forms">
                    <form action="Logindb.php" method="POST" class="login__registre" id="login-in">
                  ...
                  name="password">
                        ...
                        <!--<a href="Imageupload.php" class="login__button">Log In</a>-->
                        <input type="submit" value = "Login" class="login__button" />

                        <div>
                            <span class="login__account">Don't have an Account ?</span>
                            <a href="Register.php"><span class="login__signin" id="sign-up">Register</span></a>
                        </div>
                    </form>
